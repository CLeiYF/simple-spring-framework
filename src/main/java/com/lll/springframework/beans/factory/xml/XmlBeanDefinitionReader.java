package com.lll.springframework.beans.factory.xml;
...
import com.lll.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import com.lll.springframework.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            // 增加 init-method、destroy-method 的读取
